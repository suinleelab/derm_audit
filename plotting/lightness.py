...
def plot_lightness():
    ...
    data = [("deepderm", "lightness_shift_deepderm_f17k.csv"),
            ("modelderm", "lightness_shift_modelderm_f17k.csv"),
            ("scanoma", "lightness_shift_scanoma_f17k.csv"),
            ("sscd", "lightness_shift_sscd_f17k.csv"),
            ("siim-isic", "lightness_shift_siimisic_f17k.csv")]
    ...
    ax.xaxis.set_minor_locator(ticker.FixedLocator([-10,-5,5,10]))
    ax.set_ylabel("Mean change in model output")
    ax.legend()
    plt.savefig("L_star_f17k.pdf")
